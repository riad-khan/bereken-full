    ...
    <section class="hero bg-white pt-20 p-4 md:pt-12 md:p-12 w-full items-center mx-auto">
        <div class="container mx-auto max-w-screen-xl">
            ...
            <div class="section-title text-center ">
                <h1 class="flex justify-center items-center text-[32px] font-semibold text-[#2B313B] p-4 sm:pb-6  sm:pt-4">VAT Calculator <svg class="transition ml-2 cursor-pointer" fill="#112954" width="22" height="22" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="order-1"> <span class="flex justify-between">
                                ...
                                <div class="flex single-field-wrapper">
                                    ...
                                    <input type="text" id="amount" name="amount"
                                        class="label-span rounded-none rounded-r-md bg-white border-[#A4BCE6] text-[#6C7A93] font-normal text-xs border focus:ring-none focus:outline-none focus:border-[#3b82f6] flex-1 min-w-0 w-full p-3"
